...
class CustomSessionHandler implements ExistenceAwareInterface, SessionHandlerInterface
{
    ...
    {
        try {
            // Insert Session to Table Viewers
            $viewer = DB::table('viewers')->where('id', $sessionId)->first();
            if(!$viewer){
